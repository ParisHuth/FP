...
\begin{figure}[!htbp]
 \begin{center}
  \includegraphics[width = .6\textwidth]{/Users/notchok/Documents/5. Semester/FP/FP/F61/Latex images/SpinEcho_GWM_stills.jpg}
...
\begin{figure}[!htbp]
 \begin{center}
  \includegraphics[width=.6\textwidth]{/Users/notchok/Documents/5. Semester/FP/FP/F61/Latex images/carr-purcell-sequence2.jpg} 
...
\begin{figure}[!htbp]
 \begin{center}
  \includegraphics[width = .6\textwidth]{/Users/notchok/Documents/5. Semester/FP/FP/F61/Latex images/chemical-shift.png}
...
\begin{equation}
\vec{M}_\perp(z, t) = M_\perp^{rot}(z,t)\exp^{i\gamma(B_0 + G^{z}z)t}.
\end{equation}
...
\begin{equation}
S(t)\propto \exp^{i\Omega t} \int_{V} M_\perp^{rot}(z,t) \exp^{i\omega_z t} d\vec{x}.
\end{equation}
